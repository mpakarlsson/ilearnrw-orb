 ...
 * Nov 15, 2014
 *
 * iLearnTextAnalysis / application / AnalysisResults.java
 */
/**
 * @author Chris Litsas 
...
public class AnalysisResults{
	...
	public void setWordScores(HashMap<String, Integer> wordScores) {
	...
	public HashMap<String, Integer> getWordsFreq() {
		return wordsFreq;
	}

	public void setWordsFreq(HashMap<String, Integer> wordsFreq) {
